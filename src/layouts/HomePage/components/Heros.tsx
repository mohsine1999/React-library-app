export const Heros = () => {
return (
   <div className="d-done d-lg-block">
       ...
       <div className="row g-0">
           <div className="col-4 col-md-4 container d-flex justify-content-center
               ...
               <div className="ml-2">
                    ...
                    <p className="lead">
                       Try to check in daiky as our collection is always changing ! 
                       We work nonstop to provide the most accurate book selection possible 
                       for our Mosine's Books students! We are diligent about our book selection 
