            ...
            <div className="container" >
                <div>
                    <div className="row mt-5">
                        <div className="col-6">
                            <div className="d-flex">
                                ...
                                <button className="btn btn-outline-dark" onClick={() => searchHandleChange()}>
                                    Search
                                </button>
                            </div>
                        </div>
                    ...
                    <div className="m-5">
                        ...
                        <a type="button" href="" className="btn bg-color bg-dark btn-md px-4 me-md-2 fw-bold text-white"
                        >   Library Services.   </a>
                    </div>
                    }
                    {totalPages > 1 &&
